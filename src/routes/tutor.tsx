...
import { BookOpen, Home, Languages, Lightbulb, Mic, MicOff, Volume2, VolumeX } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col bg-[oklch(0.985_0.01_95)]">
      <header className="border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3">
          ...
          <Button asChild type="button" variant="outline" size="sm" title="Back to Home">
            <Link to="/">
              <Home className="h-4 w-4" />
              <span className="ml-1.5 hidden sm:inline">Back to Home</span>
            </Link>
          </Button>
          <LanguageToggle />
          <Button
